...
class AdminAppointmentHistoryFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_admin_appointment_history, container, false)

        db = FirebaseFirestore.getInstance()
        appointmentContainer = view.findViewById(R.id.adminAppointmentContainer)
